                  ...
                  <section>
                      <div className='text-sm grid md:grid-cols-2'>
                          <div>
                              ...
                              <ul>
                                  <li><span className='font-semibold text-primary'>GitHub: </span><span className='hover:text-[#44475a] text-[#6272a4] font-light'>github.com/pujan-modha<span className='text-primary opacity-50'>↗</span></span></li>
                                  <li><span className='font-semibold text-primary'>LinkedIn: </span><span className='hover:text-[#44475a] text-[#6272a4] font-light'>linkedin.com/in/pujan-modha<span className='text-primary opacity-50'>↗</span></span></li>
                                  <li><span className='font-semibold text-primary'>Twitter: </span><span className='hover:text-[#44475a] text-[#6272a4] font-light'>twitter.com/pujan_modha<span className='text-primary opacity-50'>↗</span></span></li>
                                  <li><span className='font-semibold text-primary'>E-Mail: </span><span className='hover:text-[#44475a] text-[#6272a4] font-light'>pujan@ieee.org<span className='text-primary opacity-50'>↗</span></span></li>
                                  <li><span className='font-semibold text-primary'>Phone: </span><span className='hover:text-[#44475a] text-[#6272a4] font-light'>+91 9484856107<span className='text-primary opacity-50'>↗</span></span></li>
                              </ul>
                          </div>
                  ...
                  <section>
                      ...
                      <div className='grid md:grid-cols-2'>
                          <div className='md:row-span-2 gap-y-[5%]'>
                              <div>
                                  <h2 className='font-semibold text-primary'>LANGUAGES</h2>
                                  <div>
                          ...
                          <div>
                              <h2 className='font-semibold text-primary'>SOFT SKILLS</h2>
                              <div>
                                  <ul className='flex flex-wrap gap-[1%]'>
                  ...
                  <section>
                      <div className='grid md:grid-cols-2'>
                          <div>
                              ...
                              <div className='text-sm'>
                                  <ul>
                                      <li><span className='font-black text-secondary'> › </span><span className='hover:text-secondary text-primary font-light'>Course 1 - Coursera</span><span> </span><span className='hover:text-primary group-hover:opacity-100 text-secondary font-light'>(Certificate<span className='text-primary opacity-50'>↗</span>)</span></li>
                                      <li><span className='font-black text-secondary'> › </span><span className='hover:text-secondary text-primary font-light'>Course 2 - Udemy</span><span> </span><span className='hover:text-primary text-secondary font-light'>(Certificate<span className='text-primary opacity-50'>↗</span>)</span></li>
                                      <li><span className='font-black text-secondary'> › </span><span className='hover:text-secondary text-primary font-light'>Course 3 - Udacity</span><span> </span><span className='hover:text-primary text-secondary font-light'>(Certificate<span className='text-primary opacity-50'>↗</span>)</span></li>
                                  </ul>
                              </div>
                          </div>
                          <hr className='md:hidden mx-auto border border-opacity-50 border-foreground my-[2.5%] w-full'/>
                          <div>
                              ...
                              <div className='text-sm'>
                                  <ul>
                                      <li><span className='font-black text-secondary'> › </span><span className='text-primary font-light'>Achievement - 1</span><span> </span><span className='hover:text-primary text-secondary font-light'>(Certificate<span className='text-primary opacity-50'>↗</span>)</span></li>
                                      <li><span className='font-black text-secondary'> › </span><span className='text-primary font-light'>Achievement - 2</span><span> </span><span className='hover:text-primary text-secondary font-light'>(Certificate<span className='text-primary opacity-50'>↗</span>)</span></li>
                                      <li><span className='font-black text-secondary'> › </span><span className='text-primary font-light'>Achievement - 3</span><span> </span><span className='hover:text-primary text-secondary font-light'>(Certificate<span className='text-primary opacity-50'>↗</span>)</span></li>
                                  </ul>
                              </div>
                          </div>
                      </div>
