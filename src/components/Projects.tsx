                    ...
                    <div className='grid print:grid-cols-2 md:grid-cols-2'>
                        <div>
                            <p className='font-semibold text-primary'><a href="/" target="_noref"
                                ...
                                - 1<span className='text-primary font-light opacity-50'>↗</span></a><span className='text-primary opacity-50 font-thin text-sm'> | </span><a href='/'
                                                                      target='_noref'
                                                                      className='opacity-75 hover:opacity-100'><FontAwesomeIcon
                                icon={faGithub} style={{color: "#6272a4"}}/><span
                                className='text-primary opacity-50 font-thin text-sm'>↗</span></a>
                                <span
                                    className='text-primary'><span className='text-primary opacity-50 font-thin text-sm'> | </span></span><a href='/'
                                                                                                                                             target='_noref'
                                                                                                                                             className='opacity-75 hover:opacity-100'><FontAwesomeIcon
                ...
                <div className='mb-[2.5%]'>
                    <div className='grid print:grid-cols-2 md:grid-cols-2'>
                        <div>
                            <p className='font-semibold text-primary'><a href="/" target="_noref"
                                                                         className='hover:text-secondary hover:underline'>PROJECT
                                - 2<span className='text-primary font-light opacity-50'>↗</span></a><span className='text-primary opacity-50 font-thin text-sm'> | </span><a href='/'
                                                                                                                                                                             target='_noref'
                                                                                                                                                                             className='opacity-75 hover:opacity-100'><FontAwesomeIcon
                                icon={faGithub} style={{color: "#6272a4"}}/><span
                                className='text-primary opacity-50 font-thin text-sm'>↗</span></a>
